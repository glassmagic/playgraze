...
- **Cores (⬢)** drop from elites, heavies, and bosses, and your score banks more when you die. Spend them in the **HANGAR SHOP** on permanent ship systems, thirteen weapons (from scatter pellets to gravity wells to a spool-up minigun), **ship hulls** with real tradeoffs (the barely-there DART up to the five-heart BRICK — bigger hulls are genuinely bigger targets), and a **pilot roster** whose hands shape your aim and fire rate. Weapons must be **discovered first**: take one as a mid-run refit card and it becomes purchasable; until then the hangar shows an UNDISCOVERED placeholder.
